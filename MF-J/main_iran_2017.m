...
% Output directories
folderName1 = 'out/iran_2017/burn/';
folderName2 = 'out/iran_2017/sampling/';
mkdir(folderName1);
mkdir(folderName2);
...
fault_lengths = 100;  % Fault lengths
fault_widths = 50;    % Fault widths
...
x_initial = [0; 0; 0; 300; 30];  % Fault parameters: [EX, EY, EZ, Strike, Dip]
lb = [-30; -30; -15; 280; 10];   % Lower bounds
ub = [30; 30; 0; 360; 50];       % Upper bounds

% Step Sizes for Parameter Sampling
step_x = [0.5; 0.5; 0.5; 1; 1];  % Fault step sizes for each parameter
...
% Fault Slip Constraints (Obtained from organizations like GCMT, USGS, GFZ)
rake = 137;    % Slip angle
MAXSLIP = 5;   % Maximum slip

%% ===================== Load Observation Data ============================
% Observation Data File Path
data_file_path = './inp/iran_2017/coseismic_SE.txt';
