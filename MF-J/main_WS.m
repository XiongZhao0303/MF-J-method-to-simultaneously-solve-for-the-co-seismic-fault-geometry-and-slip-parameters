...
% Output directories
folderName1 = 'out/WS_2024/burn/';
folderName2 = 'out/WS_2024/sampling/';
mkdir(folderName1);
mkdir(folderName2);
...
fault_lengths = 60;  % Fault lengths
fault_widths = 44;   % Fault widths
fault_params = {[16, 12]}; % Subdivisions along strike and dip

% Set initial values and parameter bounds for estimation (EX, EY, EZ, Strike, Dip)
x_initial = [0;   0;   0; 200;20]; % Fault 

% Parameter Bounds
lb = [ -30; -30;  -15;  200; 10];   % Lower bounds
ub = [  30;  30;   0;   360; 90];   % Upper bounds
...
rake = 72;     % Slip angle
MAXSLIP = 3; % Maximum slip

%% ===================== Load Observation Data ============================
% Observation Data File Path
data_file_path = './inp/WS_2024/co_WS.txt';
...
[Faults, subdivisions, M_total] = fault_geometry(num_faults, fault_lengths, fault_widths, x_initial, fault_params);
...
[x_burned, log_posterior_burned, x_acc_burn, acceptance_rate_burning] = burning_phase(...
    ...
    XY, los, D, sig_d_inv, def, Num, M_total, ls, us, Tzeros, log_posterior_initial);
...
[x_sampled, log_posterior_sampled, x_acc_sampling, mm_sampling, Slip, acceptance_rate_sampling] = sampling_phase(...
    ...
    XY, los, D, sig_d_inv, def, Num, M_total, ls, us, Tzeros, sampling_interval, log_posterior_burned);
